...
class CollectingsDetailsItem extends StatelessWidget {
  final List<OrderItems> orderItems;

  const CollectingsDetailsItem({super.key, required this.orderItems});
  @override
              ...
              rows: List<DataRow>.generate(
                  ...
                  (index) => DataRow(cells: [
                        ...
                        DataCell(
                          ...
                          // DataCell(Center(
                          //     child: Text(
                          //   "${comparisonModel!.data![index].periodicMaintenance}",
                          // ))),
                        )
                      ]))),
        ),
